...
define('dashboard','https://nohenugu.org.ng/myhq/');

define('userid_prefix','X');
define('userid_prefix_num',1000);

define("domain", "https://nohenugu.org.ng/");
define("db_host","localhost");
define("db_user","nohenugu_noxdb");
define("db_password","I@S@DZS.Ps@-phaGpA");
define("db","nohenugu_noxdb");
define("db_port",null);
